...
test.describe('-= delete command', () => {
  test('should run all delete command tests in browser', async ({ page }) => {
    await page.goto('/tests/delete-command.html');
    ...
    console.log(`Delete command tests: ${results.passed}/${results.total} passed`);
