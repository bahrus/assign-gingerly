...
test.describe('assignFeatures - Custom Element Features', () => {
  test('should run all assignFeatures tests in browser', async ({ page }) => {
    // Navigate to the HTML test page
    await page.goto('/tests/assign-features.html');
    ...
    // Log results
    console.log(`assignFeatures tests: ${results.passed}/${results.total} passed`);
