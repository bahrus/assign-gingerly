...
test.describe('assignFrom / assignFromAsync - Object Prototype Extension', () => {
  test('should run all extension tests in browser', async ({ page }) => {
    await page.goto('/tests/assignFrom-extension.html');
    ...
    console.log(`assignFrom extension tests: ${results.passed}/${results.total} passed`);
