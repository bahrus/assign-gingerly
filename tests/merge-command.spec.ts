...
test.describe('assignGingerly - Y= Merge Command', () => {
  test('should run all Y= merge command tests in browser', async ({ page }) => {
    await page.goto('/tests/merge-command.html');
    ...
    console.log(`Y= merge command tests: ${results.passed}/${results.total} passed`);
