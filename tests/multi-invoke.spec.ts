...
test.describe('assignFrom - =* multi-invoke command', () => {
  test('should run all =* multi-invoke tests in browser', async ({ page }) => {
    await page.goto('/tests/multi-invoke.html');
    ...
    console.log(`=* multi-invoke tests: ${results.passed}/${results.total} passed`);
