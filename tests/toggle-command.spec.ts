...
test.describe('assignGingerly - =! Command', () => {
  test('should run all =! command tests in browser', async ({ page }) => {
    await page.goto('/tests/toggle-command.html');
    ...
    console.log(`=! command tests: ${results.passed}/${results.total} passed`);
