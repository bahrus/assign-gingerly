...
test.describe('assignGingerly - README Examples', () => {
  test('should run all README example tests in browser', async ({ page }) => {
    await page.goto('/tests/readme-examples.html');
    ...
    console.log(`README example tests: ${results.passed}/${results.total} passed`);
