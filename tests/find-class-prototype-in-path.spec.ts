...
test.describe('findClassPrototypeInPath', () => {
  test('runs browser tests', async ({ page }) => {
    await page.goto('/tests/find-class-prototype-in-path.html');
    ...
    console.log(`findClassPrototypeInPath tests: ${results.passed}/${results.total} passed`);
