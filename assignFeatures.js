 ...
 * 
 * @param {Function} ctr - The constructor (class) to assign features to
 * @param {Object} features - Map of feature keys to their injection configs
 * @param {FeaturesRegistry} featuresRegistry - The registry to store injections in
 */
