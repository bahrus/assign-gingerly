...
- generic [active] [ref=e1]:
  ...
  - generic [ref=e3]: 13/21 tests passed
  - generic [ref=e4]:
    - generic [ref=e5]:
      - strong [ref=e6]: ✓
    ...
    - generic [ref=e21]:
      ...
      - generic [ref=e23]: undefined is not an object (evaluating 'placeholder.isReal')
    - generic [ref=e24]:
      - strong [ref=e25]: ✓
    ...
    - generic [ref=e38]:
      ...
      - generic [ref=e40]: el.whenFeatureReady is not a function. (In 'el.whenFeatureReady('feat')', 'el.whenFeatureReady' is undefined)
    - generic [ref=e41]:
      - strong [ref=e42]: ✗
      - text: "whenFeatureReady: resolves after async spawn completes"
      - generic [ref=e43]: el.whenFeatureReady is not a function. (In 'el.whenFeatureReady('feat')', 'el.whenFeatureReady' is undefined)
    - generic [ref=e44]:
      - strong [ref=e45]: ✗
